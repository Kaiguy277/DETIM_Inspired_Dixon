...
def main(resume=False):
    ...
    if resume and (OUTPUT_DIR / 'de_multistart_v14.json').exists():
        ...
        with open(OUTPUT_DIR / 'best_params_v14.json', 'w') as f:
            ...
            # lapse_rate already in save_params from PARAM_NAMES
    ...
    # lapse_rate already in posterior_df (calibrated param in PARAM_NAMES)
    ...
    summary = {
        ...
        'fixed_params': {
            # lapse_rate is now calibrated (D-034), not fixed
